<meta charset="utf-8">
  ...
  <!-- persian Date Picker -->
  <link rel="stylesheet" href="{{ asset('panel/dist/css/persian-datepicker-0.4.5.min') }}">
  <!-- Font Awesome -->
  ...
  <!--[if lt IE 9]>
  <script src="href="{{ asset('https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js') }}"></script>
  <script src="href="{{ asset('https://oss.maxcdn.com/respond/1.4.2/respond.min.js') }}"></script>
  <![endif]-->
